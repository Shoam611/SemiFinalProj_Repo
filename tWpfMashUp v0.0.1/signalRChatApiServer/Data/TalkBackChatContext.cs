    ...
    public class TalkBackChatContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Message>().HasData(
              ...
              new { MessageId = 2, Content = "dummy-content", ChatId = 1, Date = DateTime.Now, UserId = 2 },
              new { MessageId = 3, Content = "dummy-content", ChatId = 2, Date = DateTime.Now, UserId = 1 },
              new { MessageId = 4, Content = "dummy-content", ChatId = 2, Date = DateTime.Now, UserId = 3 },
              new { MessageId = 5, Content = "dummy-content", ChatId = 3, Date = DateTime.Now, UserId = 2 },
              new { MessageId = 6, Content = "dummy-content", ChatId = 3, Date = DateTime.Now, UserId = 3 },
              new { MessageId = 7, Content = "dummy-content", ChatId = 4, Date = DateTime.Now, UserId = 2 },
              new { MessageId = 8, Content = "dummy-content", ChatId = 4, Date = DateTime.Now, UserId = 4 },
              new { MessageId = 9, Content = "dummy-content", ChatId = 5, Date = DateTime.Now, UserId = 3 },
             new { MessageId = 10, Content = "dummy-content", ChatId = 5, Date = DateTime.Now, UserId = 4 }
              );

            modelBuilder.Entity<Chat>().HasOne(c => c.UserA).WithMany(u=>u.Chats);
            modelBuilder.Entity<Chat>().HasOne(c => c.UserB).WithMany(u => u.Chats);
